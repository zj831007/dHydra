...
class Action(threading.Thread):
    ...
    def log_queue(self):
        while True:
            self.logger.debug("消息队列中消息数量: {}".format(self._queue.full()))
            time.sleep(10)
    ...
    def need_new_thread(self):
        ...
        return  False
        # if (self._queue.full()):
        #     self.logger.info("消息队列中消息数量: {}, 需要增加线程".format(self._queue.full()))
        #     return True
        # else:
        #     return False
    ...
    def cancel_thread(self):
        ...
        #     self.logger.debug("消息队列中消息数量: {}, 需要减少线程".format(self._queue.empty()))
        #     return True
        # else:
        #     return False
